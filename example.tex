...
Documents contain text and may contain inline markup: \pre{inline literals}, \emph{emphasis}, \textbf{strong emphasis}, stand alone links (\url{https://www.wikibooks.org}), external hyperlinks (\href{https://www.wikibooks.org}{wikibooks home}), and \guilabel{some action}. For software library or a package use \lib{PackageName}
\lipsum[1]
